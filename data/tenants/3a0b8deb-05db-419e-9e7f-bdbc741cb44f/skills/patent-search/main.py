...
示例:
  ...
  %(prog)s company "比亚迪股份有限公司"
    ...
    # 同族专利命令
    family_parser = subparsers.add_parser('family', help='查看专利同族')
    family_parser.add_argument('patent_id', help='专利ID')
    family_parser.add_argument('--limit', '-l', type=int, default=20, help='最多显示条数 (默认: 20)')

...
const PortalTemplateDetail = lazyNamed(() => import('./pages/portal/TemplateDetailPage'), 'TemplateDetailPage')
const PortalMyChannels = lazyNamed(() => import('./pages/portal/MyChannelsPage'), 'MyChannelsPage')
const PortalChannelDetail = lazyNamed(() => import('./pages/portal/ChannelDetailPage'), 'ChannelDetailPage')
    ...
    <>
      ...
      <Routes>
        ...
        <Route
          ...
          element={
            <AdminLayout>
              <PageSuspense><ConversationsPage /></PageSuspense>
            </AdminLayout>
          }
        />
        <Route
          ...
          element={
            <AdminLayout>
              <PageSuspense><KnowledgePage /></PageSuspense>
            </AdminLayout>
          }
        />
        <Route
          ...
          element={
            <AdminLayout>
              <PageSuspense><SkillsPage /></PageSuspense>
            </AdminLayout>
          }
        />
        <Route
          ...
          element={
            <AdminLayout>
              <PageSuspense><AgentsPage /></PageSuspense>
            </AdminLayout>
          }
        />
        <Route
          ...
          element={
            <AdminLayout>
              <PageSuspense><CustomerAgentsPage /></PageSuspense>
            </AdminLayout>
          }
        />
        <Route
        ...
        <Route
          ...
          element={
            <AdminLayout>
              <PageSuspense><ChannelsPage /></PageSuspense>
            </AdminLayout>
          }
        />
        <Route
          ...
          element={
            <AdminLayout>
              <PageSuspense><RolesPage /></PageSuspense>
            </AdminLayout>
          }
        />
        <Route

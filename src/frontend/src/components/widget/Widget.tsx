...
import { X, Minus, MessageCircle, Loader2 } from 'lucide-react'
...
export function Widget({
  ...
  const [isOpen, setIsOpen] = useState(isPage || defaultOpen)
  ...
  return (
    <>
      {isOpen && !isMinimized && (
        <div
          className={cn(
            'fixed bottom-24 z-[9999] flex flex-col overflow-hidden rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 widget-enter',
